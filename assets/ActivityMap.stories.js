import{r as t,j as r}from"./iframe-BmpICDQJ.js";import{f}from"./index4.js";import{B as y}from"./useDebounce.js";import"./index.js";import{P as A}from"./Panel.js";import{A as s}from"./WordBubble.js";const x={component:s,title:"@charts/ActivityMap",parameters:{layout:"centered",controls:{exclude:"children"}}},a={render:c=>{const[m,l]=t.useState([]),e=t.useCallback(()=>{const d=Array(7),p=Array(24);l(Array.from(d,(v,u)=>Array.from(p,(b,h)=>[h,u,f.number.int({min:0,max:99})])))},[]);return t.useEffect(()=>{e()},[]),r.jsx(A,{maxWidth:"48rem",width:"100vw",height:"24rem",title:"Activity Map chart",actions:r.jsx(y,{"aria-label":"loadData",variant:"link",icon:"mdi mdi-refresh",onClick:e}),children:r.jsx(s,{...c,series:m})})},args:{}};var n,o,i;a.parameters={...a.parameters,docs:{...(n=a.parameters)==null?void 0:n.docs,source:{originalSource:`{
  render: args => {
