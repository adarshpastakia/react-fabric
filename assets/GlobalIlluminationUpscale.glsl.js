import{n as e}from"./rolldown-runtime.js";import{r as t,t as n}from"./glsl.js";import{n as r,t as i}from"./ScreenSpacePass.glsl.js";import{r as a,t as o}from"./NoParameters.js";import{n as s,t as c}from"./ShaderBuilder.js";import{n as l,t as u}from"./FloatPassUniform.js";import{n as d,t as f}from"./Texture2DPassUniform.js";import{n as p,t as m}from"./Texture2DDrawUniform.js";import{r as h,t as g}from"./ReadDepth.glsl.js";import{n as _,t as v}from"./CameraSpace.glsl.js";import{n as y,t as b}from"./GlobalIlluminationColorQuantization.glsl.js";import{n as x,t as S}from"./GlobalIlluminationWeights.glsl.js";function C(){let e=new s,n=e.fragment;return e.include(r),e.include(v),e.include(x),n.include(g),n.include(b),n.uniforms.add(new f(`depthMap`,e=>e.depthTexture),new f(`normalMap`,e=>e.normalTexture),new m(`tex`,e=>e.colorTexture),new m(`globalIlluminationWeightTexture`,e=>e.weightTexture),new l(`projScale`,(e,t)=>{let n=t.camera.distance;return n>w?Math.max(0,e.projScale-(n-w)):e.projScale})),n.code.add(t`
    ...
    void sampleJointBilateralUpscale(vec2 sampleUv, out vec4 upscaledColor, out float upscaledWeight) {
      ...
      float depthSharpness = ${t.float(T)} * globalIlluminationDepthSharpness(projScale, centerDepth, centerNormal);
  ...
  `),e.outputs.add(`fragColor`,`vec4`,0),e.outputs.add(`fragWeight`,`float`,1),n.main.add(t`sampleJointBilateralUpscale(uv, fragColor, fragWeight);
fragColor.rgb = quantizeGlobalIlluminationColor(fragColor.rgb);`),e}var w,T,E,D;function O(){return(O=e((()=>{i(),h(),S(),_(),u(),n(),p(),d(),y(),a(),c(),w=5e4,T=100,E=class extends o{},D=Object.freeze(Object.defineProperty({__proto__:null,GlobalIlluminationUpscaleDrawParameters:E,build:C},Symbol.toStringTag,{value:`Module`}))})))()}export{C as i,E as n,O as r,D as t};