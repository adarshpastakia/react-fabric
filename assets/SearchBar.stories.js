...
)`,elements:[{name:"BaseFilter"},{name:"unknown"}]},name:"filter"}],return:{name:"void"}}},description:""}}};function tn(e,a){var l=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);a&&(r=r.filter(function(c){return Object.getOwnPropertyDescriptor(e,c).enumerable})),l.push.apply(l,r)}return l}function Xa(e){for(var a=1;a<arguments.length;a++){var l=arguments[a]!=null?arguments[a]:{};a%2?tn(Object(l),!0).forEach(function(r){Ie(e,r,l[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(l)):tn(Object(l)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(l,r))})}return e}var Ha=function(a){var l=a.ref,r=a.value,c=a.schema,p=a.handlebarSuggestions,m=a.required,y=a.readOnly,s=a.minimal,h=a.onChange,t=a.language,v=t===void 0?"json":t,j=o.useState(),S=U(j,2),i=S[0],d=S[1],b=o.useState(),f=U(b,2),A=f[0],F=f[1],P=aa(),I=o.useState(""),N=U(I,2),Q=N[0],L=N[1];o.useLayoutEffect(function(){i&&L(P?"vs-dark":"light")},[P,i]);var C=o.useCallback(function(B){return i==null?void 0:i.layout(B)},[i]),g=ea(C),u=o.useDeferredValue(r),_=o.useMemo(function(){return $n(u)?u:JSON.stringify(u,null,4)},[u]),M=jn(function(B){var $=i==null?void 0:i.getModel();if($){var R=A==null?void 0:A.editor.getModelMarkers({owner:$.getLanguageId()});(R==null?void 0:R.filter(function(z){return z.severity>7}).length)===0&&(h==null||h(B))}},[h,i],1e3);o.useImperativeHandle(l,function(){return{getValue:function(){return i==null?void 0:i.getValue()},validate:function(){var $=i==null?void 0:i.getModel();if($){var R=A==null?void 0:A.editor.getModelMarkers({owner:$.getLanguageId()});return(R==null?void 0:R.filter(function(te){return te.severity>8}).length)===0}try{var z=i==null?void 0:i.getValue();return v==="json"&&(z=JSON.parse(z)),m?!pe(z):!0}catch{return!1}}}},[m,v]);var x=o.useRef(null),q=o.useCallback(function(B){if(v==="json"&&c){var $,R=Zn(c),z=R[0],te=R.slice(1);($=B.languages)===null||$===void 0||($=$.json)===null||$===void 0||$.jsonDefaults.setDiagnosticsOptions({validate:!0,allowComments:!1,schemas:[Xa({fileMatch:["*"]},z)].concat(Dn(te))})}if(v==="html"&&p){var ee,le;(ee=x.current)===null||ee===void 0||(le=ee.dispose)===null||le===void 0||le.call(ee),x.current=B.languages.registerCompletionItemProvider("html",{triggerCharacters:["{{"],provideCompletionItems:function(ne,ie){var me=ne.getValueInRange({startLineNumber:1,startColumn:1,endLineNumber:ie.lineNumber,endColumn:ie.column}),Ee=me.match(/\{\{(.*)([^}])?$/);if(!Ee)return{suggestions:[]};var ve=ne.getWordUntilPosition(ie),he={startLineNumber:ie.lineNumber,endLineNumber:ie.lineNumber,startColumn:ve.startColumn,endColumn:ve.endColumn};return{suggestions:p.map(function(ue){return{label:ue.text,kind:B.languages.CompletionItemKind.Text,documentation:ue.description,insertText:ue.text,range:he}})}}})}},[c,v]),re=o.useCallback(function(B,$){$.languages.json.jsonDefaults.setDiagnosticsOptions({validate:!0,allowComments:!1,schemas:[]})},[]);return n.jsx(na,{className:"relative",children:n.jsx("div",{ref:g,"data-ref":"codeEditor",className:H("fabric-codeEditor","absolute inset-0"),children:n.jsx(ra,{editorDidMount:function($,R){return[!!$&&d($),!!R&&F(R)]},editorWillMount:q,editorWillUnmount:re,value:_,language:v,onChange:M,theme:Q,className:"fabric-editor",options:{readOnly:y,minimap:{enabled:!s},scrollBeyondLastLine:!1,folding:!s,lineNumbers:s?"off":void 0,wordWrap:"on",fontFamily:'Menlo, Monaco, "Courier New", monospace'}})})})};const Ua=new dn({id:X().required(),label:X().required(),query:X().required().test(e=>{try{return!pe(JSON.parse(e))}catch{return!1}})}),Sn=({filter:e,onChange:a,onRemove:l})=>{const{t:r}=Z("searchbar"),c=_e(),{defaultQuery:p="",querySchema:m,queryLanguage:y}=We(),s=o.useRef(null),h=o.useMemo(()=>e&&"query"in e&&e.query?{id:e.id,query:JSON.stringify(JSON.parse(e.query??"{}"),null,4),label:e.label}:{id:ge(),label:"",query:p},[e]);o.useEffect(()=>{setTimeout(()=>{var v;(v=s.current)==null||v.focus()},100)},[]);const t=o.useCallback(v=>{const j={id:v.id,query:v.query,label:v.label};a==null||a(j),c==null||c.events.emit("close")},[a]);return n.jsxs(Fe,{schema:Ua,defaultValues:h,onSubmit:t,children:[n.jsx(ua,{color:"warning",children:"For advanced users only!"}),n.jsx(k,{name:"label",children:n.jsx(Be,{required:!0,ref:s,label:r("label.label"),placeholder:r("label.label")})}),n.jsx(k,{name:"query",children:({checked:v,error:j,invalid:S,ref:i,...d})=>n.jsxs("div",{className:"my-2",children:[n.jsx("label",{className:H("block px-2",S&&"text-danger-600"),children:r("label.query")}),n.jsx("div",{className:"h-[24rem] w-[36rem] grid outline place-content-start",style:{gridTemplate:'"content" 1fr/1fr'},children:n.jsx(Ha,{language:y??"text",minimal:!0,required:!0,...d,schema:m})})]})}),n.jsxs("div",{className:"flex mt-4 justify-end gap-1 sticky bottom-1 bg-base",children:[l&&n.jsx("div",{className:"flex-1",children:n.jsx(K,{"data-dropdown-dismiss":"true",variant:"link",size:"sm",color:"danger",onClick:l,children:r("label.remove")})}),n.jsx(K,{"data-dropdown-dismiss":"true",variant:"link",size:"sm",children:r("label.cancel")}),n.jsx(K,{type:"submit",variant:"solid",size:"sm",children:r("label.apply")})]})]})};Sn.__docgenInfo={description:"",methods:[],displayName:"QueryForm",props:{filter:{required:!1,tsType:{name:"intersection",raw:`BaseFilter &
(
  | {
      field: string;
      operator: OPERATOR;
...
@param filters`}}};const Xe=({historyKey:e="ruf:search",historyCount:a=20,defaultQueryList:l,prepend:r,append:c,decorateEnd:p,decorateStart:m,children:y,hideFilters:s,defaultCollapsed:h=!1,disabled:t,onCollapsed:v,onQuery:j,onSearch:S,query:i,ref:d,multiple:b,filters:f=He,...A})=>{const{t:F}=Z("searchbar"),[P,I]=la(e,l??[]),[N,Q]=o.useState(h),L=o.useMemo(()=>b?He:"",[b]),C=jn((x,q)=>{u({type:"dirty",dirty:!1}),S==null||S({query:x,filters:q})},[]),[g,u]=o.useReducer((x,q)=>q.type==="reset"?{...x,dirty:!1,query:q.query,filters:q.filters}:q.type==="dirty"?{...x,dirty:q.dirty}:q.type==="query"?(!b&&C(q.query??L,x.filters),{...x,dirty:!!b,query:q.query??L}):q.type==="filter"?(C(x.query,q.filters??[]),{...x,dirty:!1,filters:q.filters??[]}):x,{dirty:!1,query:i,filters:f});o.useEffect(()=>{u({type:"reset",filters:f,query:i})},[f,i]);const _=x=>{const q=oe(x)?x:[x];I(sa([...q,...P]).slice(0,a)),u({type:"query",query:x})},M=(x=[])=>{u({type:"filter",filters:x})};return n.jsxs("div",{children:[n.jsxs("div",{className:"flex flex-nowrap gap-1 mb-1",children:[n.jsxs(Te,{"data-inner":!0,className:"flex-1",children:[!s&&n.jsx(K,{variant:"link",badge:f.length,onClick:()=>Q(!N),children:F("label.filters")}),r,n.jsx(pa,{allowClear:!0,expandOnEdit:!0,ref:d,multiple:b,history:P,value:g.query,decorateEnd:p,decorateStart:m,onInput:()=>u({type:"dirty",dirty:!b}),onSelect:_,"data-ref":"searchbarInput",onEnterPressed:()=>C(g.query,g.filters)}),c,n.jsx(K,{variant:"solid",color:g.dirty?"warning":"primary",onClick:()=>C(g.query,g.filters),children:F(g.dirty?"label.update":"label.refresh")})]}),y]}),!s&&!N&&n.jsx(In,{...A,filters:g.filters,onFilterChanged:M})]})};Xe.__docgenInfo={description:`This component provides a search input with autocomplete functionality,
...
}`,onSearch:Ja(),fields:[{field:"id",label:"ID",type:D.ID},{field:"name",label:"Name",type:D.STRING},{field:"age",label:"Age",type:D.NUMBER},{field:"dob",label:"DOB",type:D.DATE},{field:"extras",label:"Extras",type:D.NONE},{field:"country",label:"Country",type:D.STRING,onSearch(e){return new Promise(a=>{setTimeout(()=>{a(kn.list.filter(l=>Ke(l.name,e)||Ke(l.fullname,e)).map(l=>l.name))},1e3)})}}],filters:[{id:ge(),field:"name",operator:E.IS,value:"Smeghead",pinned:!0,canPin:!1,canDisable:!1,required:!0,canEdit:!1,color:"lilac",icon:"mdi mdi-tray-full"},{id:ge(),field:"name",operator:E.IS,value:"Smeghead"},{id:ge(),field:"name",negate:!0,operator:E.IS,value:"Smeghead",label:"New filter"},{id:ge(),query:JSON.stringify({query:"test"}),label:"Query filter"}]}};var ln,sn,on;Ce.parameters={...Ce.parameters,docs:{...(ln=Ce.parameters)==null?void 0:ln.docs,source:{originalSource:`{
  render: args => {
