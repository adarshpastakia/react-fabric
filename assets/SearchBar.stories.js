...
@param filters`}}};const Xe=({historyKey:e="ruf:search",historyCount:r=20,defaultQueryList:t,prepend:a,append:p,decorateEnd:m,decorateStart:b,children:f,hideFilters:s,defaultCollapsed:y=!1,disabled:l,onCollapsed:v,onQuery:x,onSearch:E,query:u,ref:d,multiple:c,filters:h=He,...A})=>{const{t:k}=ne("searchbar"),[F,T]=lr(e,t??[]),[q,_]=o.useState(y),L=o.useMemo(()=>c?He:"",[c]),P=jn((j,I)=>{i({type:"dirty",dirty:!1}),E==null||E({query:j,filters:I})},[]),[g,i]=o.useReducer((j,I)=>I.type==="reset"?{...j,dirty:!1,query:I.query,filters:I.filters}:I.type==="dirty"?{...j,dirty:I.dirty}:I.type==="query"?(!c&&P(I.query??L,j.filters),{...j,dirty:!!c,query:I.query??L}):I.type==="filter"?(P(j.query,I.filters??[]),{...j,dirty:!1,filters:I.filters??[]}):j,{dirty:!1,query:u,filters:h});o.useEffect(()=>{i({type:"reset",filters:h,query:u})},[h,u]);const R=j=>{const I=ue(j)?j:[j];T(sr([...I,...F]).slice(0,r)),i({type:"query",query:j})},M=(j=[])=>{i({type:"filter",filters:j})};return n.jsxs("div",{children:[n.jsxs("div",{className:"flex flex-nowrap gap-1 mb-1",children:[n.jsxs(qe,{"data-inner":!0,className:"flex-1",children:[!s&&n.jsx(Y,{variant:"link",badge:h.length,onClick:()=>_(!q),children:k("label.filters")}),a,n.jsx(pr,{allowClear:!0,expandOnEdit:!0,ref:d,multiple:c,history:F,value:g.query,decorateEnd:m,decorateStart:b,onInput:()=>i({type:"dirty",dirty:!c}),onSelect:R,"data-ref":"searchbarInput",onEnterPressed:()=>P(g.query,g.filters)}),p,n.jsx(Y,{variant:"solid",color:g.dirty?"warning":"primary",onClick:()=>P(g.query,g.filters),children:k(g.dirty?"label.update":"label.refresh")})]}),f]}),!s&&!q&&n.jsx(In,{...A,filters:g.filters,onFilterChanged:M})]})};Xe.__docgenInfo={description:`This component provides a search input with autocomplete functionality,
...
}`,...(on=(sn=$e.parameters)==null?void 0:sn.docs)==null?void 0:on.source}}};const _a=["_SearchBar"];export{$e as _SearchBar,_a as __namedExportsOrder,Qa as default};
