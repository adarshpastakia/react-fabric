...
)`,elements:[{name:"BaseFilter"},{name:"unknown"}]},name:"filter"}],return:{name:"void"}}},description:""}}};function tn(e,r){var t=Object.keys(e);if(Object.getOwnPropertySymbols){var a=Object.getOwnPropertySymbols(e);r&&(a=a.filter(function(p){return Object.getOwnPropertyDescriptor(e,p).enumerable})),t.push.apply(t,a)}return t}function Xr(e){for(var r=1;r<arguments.length;r++){var t=arguments[r]!=null?arguments[r]:{};r%2?tn(Object(t),!0).forEach(function(a){Ne(e,a,t[a])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(t)):tn(Object(t)).forEach(function(a){Object.defineProperty(e,a,Object.getOwnPropertyDescriptor(t,a))})}return e}var Hr=function(r){var t=r.ref,a=r.value,p=r.schema,m=r.handlebarSuggestions,b=r.required,f=r.readOnly,s=r.minimal,y=r.onChange,l=r.language,v=l===void 0?"json":l,j=o.useState(),E=K(j,2),u=E[0],d=E[1],c=o.useState(),h=K(c,2),A=h[0],k=h[1],F=rr(),T=o.useState(""),q=K(T,2),_=q[0],P=q[1];o.useLayoutEffect(function(){u&&P(F?"vs-dark":"light")},[F,u]);var R=o.useCallback(function(G){return u==null?void 0:u.layout(G)},[u]),g=er(R),i=o.useDeferredValue(a),L=o.useMemo(function(){return $n(i)?i:JSON.stringify(i,null,4)},[i]),M=jn(function(G){var N=u==null?void 0:u.getModel();if(N){var V=A==null?void 0:A.editor.getModelMarkers({owner:N.getLanguageId()});(V==null?void 0:V.filter(function(X){return X.severity>7}).length)===0&&(y==null||y(G))}},[y,u],1e3);o.useImperativeHandle(t,function(){return{getValue:function(){return u==null?void 0:u.getValue()},validate:function(){var N=u==null?void 0:u.getModel();if(N){var V=A==null?void 0:A.editor.getModelMarkers({owner:N.getLanguageId()});return(V==null?void 0:V.filter(function(ae){return ae.severity>8}).length)===0}try{var X=u==null?void 0:u.getValue();return v==="json"&&(X=JSON.parse(X)),b?!ce(X):!0}catch{return!1}}}},[b,v]);var x=o.useRef(null),I=o.useCallback(function(G){if(v==="json"&&p){var N,V=Zn(p),X=V[0],ae=V.slice(1);(N=G.languages)===null||N===void 0||(N=N.json)===null||N===void 0||N.jsonDefaults.setDiagnosticsOptions({validate:!0,allowComments:!1,schemas:[Xr({fileMatch:["*"]},X)].concat(Dn(ae))})}if(v==="html"&&m){var te,J;(te=x.current)===null||te===void 0||(J=te.dispose)===null||J===void 0||J.call(te),x.current=G.languages.registerCompletionItemProvider("html",{triggerCharacters:["{{"],provideCompletionItems:function(le,Z){var we=le.getValueInRange({startLineNumber:1,startColumn:1,endLineNumber:Z.lineNumber,endColumn:Z.column}),Ee=we.match(/\{\{(.*)([^}])?$/);if(!Ee)return{suggestions:[]};var pe=le.getWordUntilPosition(Z),ve={startLineNumber:Z.lineNumber,endLineNumber:Z.lineNumber,startColumn:pe.startColumn,endColumn:pe.endColumn};return{suggestions:m.map(function(me){return{label:me.text,kind:G.languages.CompletionItemKind.Text,documentation:me.description,insertText:me.text,range:ve}})}}})}},[p,v]),re=o.useCallback(function(G,N){N.languages.json.jsonDefaults.setDiagnosticsOptions({validate:!0,allowComments:!1,schemas:[]})},[]);return n.jsx(nr,{className:"relative",children:n.jsx("div",{ref:g,"data-ref":"codeEditor",className:U("fabric-codeEditor","absolute inset-0"),children:n.jsx(ar,{editorDidMount:function(N,V){return[!!N&&d(N),!!V&&k(V)]},editorWillMount:I,editorWillUnmount:re,value:L,language:v,onChange:M,theme:_,className:"fabric-editor",options:{readOnly:f,minimap:{enabled:!s},scrollBeyondLastLine:!1,folding:!s,lineNumbers:s?"off":void 0,wordWrap:"on",fontFamily:'Menlo, Monaco, "Courier New", monospace'}})})})};const Ur=new dn({id:H().required(),label:H().required(),query:H().required().test(e=>{try{return!ce(JSON.parse(e))}catch{return!1}})}),Sn=({filter:e,onChange:r,onRemove:t})=>{const{t:a}=ne("searchbar"),p=_e(),{defaultQuery:m="",querySchema:b,queryLanguage:f}=We(),s=o.useRef(null),y=o.useMemo(()=>e&&"query"in e&&e.query?{id:e.id,query:JSON.stringify(JSON.parse(e.query??"{}"),null,4),label:e.label}:{id:ye(),label:"",query:m},[e]);o.useEffect(()=>{setTimeout(()=>{var v;(v=s.current)==null||v.focus()},100)},[]);const l=o.useCallback(v=>{const j={id:v.id,query:v.query,label:v.label};r==null||r(j),p==null||p.events.emit("close")},[r]);return n.jsxs(Pe,{schema:Ur,defaultValues:y,onSubmit:l,children:[n.jsx(ur,{color:"warning",children:"For advanced users only!"}),n.jsx(D,{name:"label",children:n.jsx(Be,{required:!0,ref:s,label:a("label.label"),placeholder:a("label.label")})}),n.jsx(D,{name:"query",children:({checked:v,error:j,invalid:E,ref:u,...d})=>n.jsxs("div",{className:"my-2",children:[n.jsx("label",{className:U("block px-2",E&&"text-danger-600"),children:a("label.query")}),n.jsx("div",{className:"h-[24rem] w-[36rem] grid outline place-content-start",style:{gridTemplate:'"content" 1fr/1fr'},children:n.jsx(Hr,{language:f??"text",minimal:!0,required:!0,...d,schema:b})})]})}),n.jsxs("div",{className:"flex mt-4 justify-end gap-1 sticky bottom-1 bg-base",children:[t&&n.jsx("div",{className:"flex-1",children:n.jsx(Y,{"data-dropdown-dismiss":"true",variant:"link",size:"sm",color:"danger",onClick:t,children:a("label.remove")})}),n.jsx(Y,{"data-dropdown-dismiss":"true",variant:"link",size:"sm",children:a("label.cancel")}),n.jsx(Y,{type:"submit",variant:"solid",size:"sm",children:a("label.apply")})]})]})};Sn.__docgenInfo={description:"",methods:[],displayName:"QueryForm",props:{filter:{required:!1,tsType:{name:"intersection",raw:`BaseFilter &
(
  | {
      field: string;
      operator: OPERATOR;
...
)`,elements:[{name:"BaseFilter"},{name:"unknown"}]},name:"filter"}],return:{name:"void"}}},description:""}}};const ze=({filter:e,onRemove:r,onChange:t})=>{const{t:a}=ne("searchbar"),{fields:p}=We(),[m,b]=o.useState(ce(p));return o.useEffect(()=>{b(!!e&&"query"in e)},[e]),n.jsxs("div",{className:"px-2 py-1 bg-base outline min-w-[420px]",children:[!ce(p)&&n.jsx("div",{className:"pb-4 flex justify-end",children:n.jsx("span",{role:"none",className:"text-sm link",onClick:()=>b(!m),children:a(m?"label.basicFilter":"label.customQuery")})}),!m&&n.jsx(En,{filter:e,onRemove:r,onChange:t}),m&&n.jsx(Sn,{filter:e,onRemove:r,onChange:t})]})};ze.__docgenInfo={description:"",methods:[],displayName:"FilterEdit",props:{filter:{required:!1,tsType:{name:"intersection",raw:`BaseFilter &
(
  | {
      field: string;
      operator: OPERATOR;
...
)`,elements:[{name:"BaseFilter"},{name:"unknown"}]},name:"filter"}],return:{name:"void"}}},description:""}}};const Tn=({filter:e,onRemove:r})=>{const{t}=ne("searchbar"),a=o.useMemo(()=>{var p,m,b,f;if("query"in e)return JSON.stringify(JSON.parse(e.query??"{}"),null,2);if("field"in e){let s=(p=e.value)==null?void 0:p.toString();return e.operator===w.BETWEEN&&ie(e.value)&&(s=`[${(m=e.value)==null?void 0:m.join(" - ")}]`),e.operator===w.ANY&&ie(e.value)&&(s=`[${(b=e.value)==null?void 0:b.join(", ")}]`),e.operator===w.ALL&&ie(e.value)&&(s=`(${(f=e.value)==null?void 0:f.join(", ")})`),n.jsxs(o.Fragment,{children:[e.negate&&n.jsx("b",{children:"NOT "}),n.jsx("span",{children:e.field}),n.jsxs("b",{children:[" ",t(`operator.${e.operator}`)," "]}),n.jsx("div",{children:s})]})}return""},[e]);return n.jsxs("div",{className:"p-2 bg-base relative",children:["query"in e&&n.jsx("div",{className:"absolute top-2 end-2 z-10",children:n.jsx(tr,{size:"sm",text:a})}),n.jsx("pre",{className:"overflow-auto bg-base outline text-sm p-2 max-h-[24rem] max-w-[48rem] min-w-[24rem]",children:a}),!e.required&&n.jsx(Y,{size:"sm",variant:"link",color:"danger","data-dropdown-dismiss":"true",onClick:r,children:t("label.remove")})]})};Tn.__docgenInfo={description:"",methods:[],displayName:"FilterView",props:{filter:{required:!0,tsType:{name:"intersection",raw:`BaseFilter &
(
  | {
      field: string;
      operator: OPERATOR;
...
@param filters`}}};const Xe=({historyKey:e="ruf:search",historyCount:r=20,defaultQueryList:t,prepend:a,append:p,decorateEnd:m,decorateStart:b,children:f,hideFilters:s,defaultCollapsed:y=!1,disabled:l,onCollapsed:v,onQuery:j,onSearch:E,query:u,ref:d,multiple:c,filters:h=He,...A})=>{const{t:k}=ne("searchbar"),[F,T]=lr(e,t??[]),[q,_]=o.useState(y),P=o.useMemo(()=>c?He:"",[c]),R=jn((x,I)=>{i({type:"dirty",dirty:!1}),E==null||E({query:x,filters:I})},[]),[g,i]=o.useReducer((x,I)=>I.type==="reset"?{...x,dirty:!1,query:I.query,filters:I.filters}:I.type==="dirty"?{...x,dirty:I.dirty}:I.type==="query"?(!c&&R(I.query??P,x.filters),{...x,dirty:!!c,query:I.query??P}):I.type==="filter"?(R(x.query,I.filters??[]),{...x,dirty:!1,filters:I.filters??[]}):x,{dirty:!1,query:u,filters:h});o.useEffect(()=>{i({type:"reset",filters:h,query:u})},[h,u]);const L=x=>{const I=ie(x)?x:[x];T(sr([...I,...F]).slice(0,r)),i({type:"query",query:x})},M=(x=[])=>{i({type:"filter",filters:x})};return n.jsxs("div",{children:[n.jsxs("div",{className:"flex flex-nowrap gap-1 mb-1",children:[n.jsxs(qe,{"data-inner":!0,className:"flex-1",children:[!s&&n.jsx(Y,{variant:"link",badge:h.length,onClick:()=>_(!q),children:k("label.filters")}),a,n.jsx(pr,{allowClear:!0,expandOnEdit:!0,ref:d,multiple:c,history:F,value:g.query,decorateEnd:m,decorateStart:b,onInput:()=>i({type:"dirty",dirty:!c}),onSelect:L,"data-ref":"searchbarInput",onEnterPressed:()=>R(g.query,g.filters)}),p,n.jsx(Y,{variant:"solid",color:g.dirty?"warning":"primary",onClick:()=>R(g.query,g.filters),children:k(g.dirty?"label.update":"label.refresh")})]}),f]}),!s&&!q&&n.jsx(In,{...A,filters:g.filters,onFilterChanged:M})]})};Xe.__docgenInfo={description:`This component provides a search input with autocomplete functionality,
