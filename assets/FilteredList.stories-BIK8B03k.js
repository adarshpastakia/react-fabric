import{aQ as a,j as e}from"./iframe-DcfUrZ2L.js";import{I as p}from"./Tooltip-Dv6V4Byx.js";import"./index-Bl9sirez.js";import{C as u}from"./Card-CZJ0ddcV.js";import{T as h}from"./Title-YO6WK8jo.js";import{H as x}from"./HeadFoot-BdfsRs4J.js";import{S as f}from"./Section-Dbs60dt2.js";import{V as g}from"./Viewport-CcMKmxve.js";import"./ColorPicker-B2sfWfiP.js";import"./Google-DSP-6Nrb.js";import{u as S,S as j,a as v}from"./List-cGuqJBjF.js";import{m as N}from"./_isEqual-PxFgnGsO.js";const L={title:"@data/useFilteredList",parameters:{layout:"fullscreen",controls:{exclude:"data"}}},r={render:F=>{const{filteredList:t,isSearching:l,onSearch:o,query:m}=S(a.list,(s,d)=>N(s.name,d));return e.jsx("div",{className:"min-h-[600px]",children:e.jsx(g,{children:e.jsxs(f,{children:[e.jsx(x,{className:"gap-2 p-2",children:e.jsxs("div",{className:"container",children:[e.jsx(j,{autoFocus:!0,value:m,onSearch:o,searching:l}),e.jsxs("div",{className:"py-2",children:["Showing ",t.length,"/",a.list.length," records"]})]})}),e.jsx(v,{items:t,hideScroller:!0,fullWidth:!0,children:({item:s})=>e.jsx("div",{className:"p-2 container max-w-96",children:e.jsxs(u,{children:[e.jsxs(h,{className:"flex items-center gap-2",children:[e.jsx(p,{className:"flex-content",size:"2rem",icon:`flag ${s.iso2}`}),e.jsx("span",{className:"flex-1 truncate",children:s.name}),e.jsxs("span",{className:"text-sm text-muted flex-content",children:[s.iso2,"/",s.iso3]})]}),e.jsx("div",{children:s.capital})]})})})]})})})},args:{}};var n,i,c;r.parameters={...r.parameters,docs:{...(n=r.parameters)==null?void 0:n.docs,source:{originalSource:`{
  render: args => {
    const {
      filteredList,
      isSearching,
