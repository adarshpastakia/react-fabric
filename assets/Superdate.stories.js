...
]`,computed:!1},required:!1},value:{defaultValue:{value:'""',computed:!1},required:!1}}};const Ce=j({from:j({diff:A().required().label("Difference"),op:g().required().oneOf(["+","-"]).label("Operator"),part:g().required().oneOf(Object.values(S)).label("Date part")}),to:j({diff:A().required().label("Difference"),op:g().required().oneOf(["+","-"]).label("Operator"),part:g().required().oneOf(Object.values(S)).label("Date part")})}),re=({value:n="",onChange:a})=>{const{t:s}=N("superdate"),o=i.useCallback(({to:l,from:r})=>{a(`${r.part}${r.op}${r.diff}|${l.part}${l.op}${l.diff}`)},[]),t=i.useMemo(()=>{if(n!=null&&n.match(/^(\$\w+)([+-])(\d+)?\|(\$\w+)([+-])(\d+)?$/)){const[,l,r,u="0"]=n.split("|").shift().match(/^(\$\w+)([+-])(\d+)?$/)??[],[,p,v,c="0"]=n.split("|").pop().match(/^(\$\w+)([+-])(\d+)?$/)??[];return{from:{part:l,op:r,diff:u},to:{part:p,op:v,diff:c}}}},[n]);return e.jsx(M,{children:e.jsx("div",{className:"scale-90",children:e.jsxs(ae,{resolver:ee(Ce),defaultValues:t,onSubmit:o,children:[e.jsx(O,{label:s("label.from"),prefix:"from"}),e.jsx(O,{label:s("label.to"),prefix:"to"}),e.jsx("div",{className:"flex justify-end",children:e.jsx(R,{variant:"solid",color:"primary",size:"sm",type:"submit","data-dropdown-dismiss":"true",children:s("label.apply")})})]})})})};re.__docgenInfo={description:"",methods:[],displayName:"RelativePanel",props:{value:{defaultValue:{value:'""',computed:!1},required:!1}}};const P=({events:n,value:a,presets:s,recurringEvents:o,onChange:t})=>{const{t:l}=N("superdate"),r=ne(),{currentCalendar:u,currentLocale:p}=Z(),v=i.useMemo(()=>u==="hijri",[u]),[c,k]=i.useState(""),[C,m]=i.useState("quick");i.useEffect(()=>{a!=null&&a.match(/^(\$\w+)([+-])(\d+)\|(\$\w+)([+-])(\d+)$/)?m("relative"):a&&!(a!=null&&a.match(/^(\$\w+)/))?m("absolute"):m("quick"),a&&k(a)},[a]);const d=i.useCallback($=>{var f,w,h,y;const b=x.parseRange($);k($),t==null||t($,[(w=(f=b[0])==null?void 0:f.toISOString)==null?void 0:w.call(f),(y=(h=b[1])==null?void 0:h.toISOString)==null?void 0:y.call(h)]),r==null||r.events.emit("close")},[v,p]);return e.jsx("div",{className:se("rounded-capped outline select-none overflow-hidden grid","fabric-superDate"),children:e.jsxs(me,{headerClassName:"border-b",onChange:m,activeTab:C,children:[e.jsx(D,{id:"quick",label:l("label.quick"),children:e.jsx(te,{value:c,onChange:d,presets:s})}),e.jsx(D,{id:"relative",label:l("label.relative"),children:e.jsx(re,{value:c,onChange:d})}),e.jsx(D,{id:"absolute",label:l("label.absolute"),children:e.jsx(M,{className:"p-0",children:e.jsx($e,{withTime:!0,showHijriToggle:!0,value:c?x.parseRange(c):void 0,showApply:!0,onChange:([$,b])=>d==null?void 0:d(`${$}|${b}`)})})}),e.jsx(D,{id:"events",label:l("label.events"),children:e.jsx(he,{isHijri:v,onChange:d,events:n,recurringEvents:o})})]})})},V=({as:n="button",color:a="primary",size:s,variant:o,disabled:t,fullWidth:l,onChange:r,value:u,"data-test-value":p,"data-testid":v,...c})=>{const{currentCalendar:k,currentLocale:C}=Z(),m=i.useMemo(()=>k==="hijri",[k]),[d,$]=i.useState();i.useEffect(()=>{$(u)},[u]);const b=i.useCallback(w=>{var y,L,_,W;const h=x.parseRange(w);$(w),r==null||r(w,[(L=(y=h[0])==null?void 0:y.toISOString)==null?void 0:L.call(y),(W=(_=h[1])==null?void 0:_.toISOString)==null?void 0:W.call(_)])},[m,C]),f=n==="button"?R:ue;return e.jsxs(ie,{showArrow:!0,children:[e.jsx(de,{content:x.relativeTooltip(d,m),children:e.jsx(f,{icon:"icon-[mdi--clock-outline]",size:s,color:a,disabled:t,fullWidth:l,variant:o,"data-test-value":p,"data-testid":v,children:x.relativeLabel(d,m)??""})}),e.jsx(P,{...c,value:d,onChange:b})]})};P.__docgenInfo={description:"",methods:[],displayName:"SuperDateTabs",props:{as:{required:!1,tsType:{name:"union",raw:'"button" | "chip"',elements:[{name:"literal",value:'"button"'},{name:"literal",value:'"chip"'}]},description:""},color:{required:!1,tsType:{name:"ColorState"},description:""},size:{required:!1,tsType:{name:"SizeType"},description:""},variant:{required:!1,tsType:{name:"union",raw:'"solid" | "outline" | "link"',elements:[{name:"literal",value:'"solid"'},{name:"literal",value:'"outline"'},{name:"literal",value:'"link"'}]},description:""},disabled:{required:!1,tsType:{name:"boolean"},description:""},fullWidth:{required:!1,tsType:{name:"boolean"},description:""},value:{required:!1,tsType:{name:"string"},description:"relative date value"},onChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(value: string, dates: [string, string]) => void",signature:{arguments:[{type:{name:"string"},name:"value"},{type:{name:"tuple",raw:"[string, string]",elements:[{name:"string"},{name:"string"}]},name:"dates"}],return:{name:"void"}}},description:"change handler"},events:{required:!1,tsType:{name:"Array",elements:[{name:"EventType"}],raw:"EventType[]"},description:"list of calendar events"},recurringEvents:{required:!1,tsType:{name:"Array",elements:[{name:"EventType"}],raw:"EventType[]"},description:"list of calendar events"},presets:{required:!1,tsType:{name:"Array",elements:[{name:"PresetType"}],raw:"PresetType[]"},description:`list of relative presets
...
{value:'$year-5|$year', label:'last 5 years'}`}},composes:["TestProps"]};const{action:Ie}=__STORYBOOK_MODULE_ACTIONS__,Ee={component:V,title:"@superdate/Superdate",parameters:{layout:"centered",controls:{exclude:"children"}}},q={render:n=>e.jsx(V,{...n}),args:{value:"$year-2|$now",recurringEvents:[{label:"National Day",start:"2000-11-30",end:"2000-12-03"}],presets:[{value:"$year-2|$now",label:"Last 2 years"},{value:"$year-5|$now",label:"Last 5 years"},{value:"$year-10|$now",label:"Last 10 years"}]}},T={render:n=>{const[a,s]=i.useState(n.value),[o,t]=i.useMemo(()=>a?x.parseRange(a):[],[a]);return e.jsxs("div",{children:[e.jsx("div",{className:"inline-block",children:e.jsx(P,{...n,value:a,onChange:(...l)=>{s(l[0]),Ie("onChange")(...l)}})}),e.jsxs("div",{className:"mt-8",children:[e.jsx("span",{className:"text-muted",children:"Relative value: "}),e.jsx("span",{className:"font-medium",children:a})]}),e.jsxs("div",{children:[e.jsx("span",{className:"text-muted",children:"Actual value: "}),e.jsx(z,{date:o,showAlternateDate:!0}),e.jsx("span",{children:" ⇾ "}),e.jsx(z,{date:t,showAlternateDate:!0,children:e.jsxs(oe,{children:[e.jsx(I,{label:"± 1 Day",onClick:()=>t&&s(`${H(t,-1).toISOString()}|${H(t,1).toISOString()}`)}),e.jsx(I,{label:"± 1 Week",onClick:()=>t&&s(`${Q(t,-1).toISOString()}|${Q(t,1).toISOString()}`)}),e.jsx(I,{label:"± 1 Month",onClick:()=>t&&s(`${Y(t,-1).toISOString()}|${Y(t,1).toISOString()}`)})]})})]})]})},args:{value:"$year-2|$now"}};var B,U,G;q.parameters={...q.parameters,docs:{...(B=q.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render: args => {
...
}`,...(X=(J=T.parameters)==null?void 0:J.docs)==null?void 0:X.source}}};const Ae=["_Superdate","Playground"],Je=Object.freeze(Object.defineProperty({__proto__:null,Playground:T,_Superdate:q,__namedExportsOrder:Ae,default:Ee},Symbol.toStringTag,{value:"Module"}));export{T as P,Je as S,q as _,V as a};
