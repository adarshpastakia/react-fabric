...
]`,computed:!1},required:!1},value:{defaultValue:{value:'""',computed:!1},required:!1}}};const Ne=j({from:j({diff:A().required().label("Difference"),op:g().required().oneOf(["+","-"]).label("Operator"),part:g().required().oneOf(Object.values(S)).label("Date part")}),to:j({diff:A().required().label("Difference"),op:g().required().oneOf(["+","-"]).label("Operator"),part:g().required().oneOf(Object.values(S)).label("Date part")})}),te=({value:n="",onChange:a})=>{const{t:s}=C("superdate"),o=i.useCallback(({to:l,from:r})=>{a(`${r.part}${r.op}${r.diff}|${l.part}${l.op}${l.diff}`)},[]),t=i.useMemo(()=>{if(n!=null&&n.match(/^(\$\w+)([+-])(\d+)?\|(\$\w+)([+-])(\d+)?$/)){const[,l,r,u="0"]=n.split("|").shift().match(/^(\$\w+)([+-])(\d+)?$/)??[],[,p,v,c="0"]=n.split("|").pop().match(/^(\$\w+)([+-])(\d+)?$/)??[];return{from:{part:l,op:r,diff:u},to:{part:p,op:v,diff:c}}}},[n]);return e.jsx(M,{children:e.jsx("div",{className:"scale-90",children:e.jsxs(ee,{schema:Ne,defaultValues:t,onSubmit:o,children:[e.jsx(O,{label:s("label.from"),prefix:"from"}),e.jsx(O,{label:s("label.to"),prefix:"to"}),e.jsx("div",{className:"flex justify-end",children:e.jsx(R,{variant:"solid",type:"submit","data-dropdown-dismiss":"true",children:s("label.apply")})})]})})})};te.__docgenInfo={description:"",methods:[],displayName:"RelativePanel",props:{value:{defaultValue:{value:'""',computed:!1},required:!1}}};const P=({events:n,value:a,presets:s,recurringEvents:o,onChange:t})=>{const{t:l}=C("superdate"),r=re(),{currentCalendar:u,currentLocale:p}=Z(),v=i.useMemo(()=>u==="hijri",[u]),[c,k]=i.useState(""),[N,m]=i.useState("quick");i.useEffect(()=>{a!=null&&a.match(/^(\$\w+)([+-])(\d+)\|(\$\w+)([+-])(\d+)$/)?m("relative"):a&&!(a!=null&&a.match(/^(\$\w+)/))?m("absolute"):m("quick"),a&&k(a)},[a]);const d=i.useCallback($=>{var f,w,h,y;const b=x.parseRange($);k($),t==null||t($,[(w=(f=b[0])==null?void 0:f.toISOString)==null?void 0:w.call(f),(y=(h=b[1])==null?void 0:h.toISOString)==null?void 0:y.call(h)]),r==null||r.events.emit("close")},[v,p]);return e.jsx("div",{className:ne("rounded-capped outline select-none overflow-hidden grid","fabric-superDate"),children:e.jsxs(me,{headerClassName:"border-b",onChange:m,activeTab:N,children:[e.jsx(D,{id:"quick",label:l("label.quick"),children:e.jsx(ae,{value:c,onChange:d,presets:s})}),e.jsx(D,{id:"relative",label:l("label.relative"),children:e.jsx(te,{value:c,onChange:d})}),e.jsx(D,{id:"absolute",label:l("label.absolute"),children:e.jsx(M,{className:"p-0",children:e.jsx($e,{withTime:!0,showHijriToggle:!0,value:c?x.parseRange(c):void 0,showApply:!0,onChange:([$,b])=>d==null?void 0:d(`${$}|${b}`)})})}),e.jsx(D,{id:"events",label:l("label.events"),children:e.jsx(he,{isHijri:v,onChange:d,events:n,recurringEvents:o})})]})})},V=({as:n="button",color:a="primary",size:s,variant:o,disabled:t,fullWidth:l,onChange:r,value:u,"data-test-value":p,"data-testid":v,...c})=>{const{currentCalendar:k,currentLocale:N}=Z(),m=i.useMemo(()=>k==="hijri",[k]),[d,$]=i.useState();i.useEffect(()=>{$(u)},[u]);const b=i.useCallback(w=>{var y,L,_,W;const h=x.parseRange(w);$(w),r==null||r(w,[(L=(y=h[0])==null?void 0:y.toISOString)==null?void 0:L.call(y),(W=(_=h[1])==null?void 0:_.toISOString)==null?void 0:W.call(_)])},[m,N]),f=n==="button"?R:ue;return e.jsxs(ie,{showArrow:!0,children:[e.jsx(de,{content:x.relativeTooltip(d,m),children:e.jsx(f,{icon:le.clock,size:s,color:a,disabled:t,fullWidth:l,variant:o,"data-test-value":p,"data-testid":v,children:x.relativeLabel(d,m)??""})}),e.jsx(P,{...c,value:d,onChange:b})]})};P.__docgenInfo={description:"",methods:[],displayName:"SuperDateTabs",props:{as:{required:!1,tsType:{name:"union",raw:'"button" | "chip"',elements:[{name:"literal",value:'"button"'},{name:"literal",value:'"chip"'}]},description:""},color:{required:!1,tsType:{name:"ColorState"},description:""},size:{required:!1,tsType:{name:"SizeType"},description:""},variant:{required:!1,tsType:{name:"union",raw:'"solid" | "outline" | "link"',elements:[{name:"literal",value:'"solid"'},{name:"literal",value:'"outline"'},{name:"literal",value:'"link"'}]},description:""},disabled:{required:!1,tsType:{name:"boolean"},description:""},fullWidth:{required:!1,tsType:{name:"boolean"},description:""},value:{required:!1,tsType:{name:"string"},description:"relative date value"},onChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(value: string, dates: [string, string]) => void",signature:{arguments:[{type:{name:"string"},name:"value"},{type:{name:"tuple",raw:"[string, string]",elements:[{name:"string"},{name:"string"}]},name:"dates"}],return:{name:"void"}}},description:"change handler"},events:{required:!1,tsType:{name:"Array",elements:[{name:"EventType"}],raw:"EventType[]"},description:"list of calendar events"},recurringEvents:{required:!1,tsType:{name:"Array",elements:[{name:"EventType"}],raw:"EventType[]"},description:"list of calendar events"},presets:{required:!1,tsType:{name:"Array",elements:[{name:"PresetType"}],raw:"PresetType[]"},description:`list of relative presets
