import{aQ as a,j as e}from"./iframe-CVyMRGSP.js";import{I as p}from"./Tooltip-D82JqM4y.js";import"./index-D3XXfjI1.js";import{C as u}from"./Card-DW5mIZq_.js";import{T as h}from"./Title-Cm6WFtyt.js";import{H as x}from"./HeadFoot-gLuWE0O1.js";import{S as f}from"./Section-BWnuMXLb.js";import{V as g}from"./Viewport-BXUQz2Et.js";import"./ColorPicker-BwNyvkQX.js";import"./Google-DJpRc7c-.js";import{u as S,S as j,a as v}from"./List-DspO0FFg.js";import{m as N}from"./_isEqual-C0Ek68wL.js";const L={title:"@data/useFilteredList",parameters:{layout:"fullscreen",controls:{exclude:"data"}}},r={render:F=>{const{filteredList:t,isSearching:l,onSearch:o,query:m}=S(a.list,(s,d)=>N(s.name,d));return e.jsx("div",{className:"min-h-[600px]",children:e.jsx(g,{children:e.jsxs(f,{children:[e.jsx(x,{className:"gap-2 p-2",children:e.jsxs("div",{className:"container",children:[e.jsx(j,{autoFocus:!0,value:m,onSearch:o,searching:l}),e.jsxs("div",{className:"py-2",children:["Showing ",t.length,"/",a.list.length," records"]})]})}),e.jsx(v,{items:t,hideScroller:!0,fullWidth:!0,children:({item:s})=>e.jsx("div",{className:"p-2 container max-w-96",children:e.jsxs(u,{children:[e.jsxs(h,{className:"flex items-center gap-2",children:[e.jsx(p,{className:"flex-content",size:"2rem",icon:`flag ${s.iso2}`}),e.jsx("span",{className:"flex-1 truncate",children:s.name}),e.jsxs("span",{className:"text-sm text-muted flex-content",children:[s.iso2,"/",s.iso3]})]}),e.jsx("div",{children:s.capital})]})})})]})})})},args:{}};var n,i,c;r.parameters={...r.parameters,docs:{...(n=r.parameters)==null?void 0:n.docs,source:{originalSource:`{
  render: args => {
    const {
      filteredList,
      isSearching,
