  ...
  render: args => {
    ...
    return <Panel width="48rem" height="24rem" title="Generic chart" expandable>
        ...
        show: false
              ...
              <Button value="treemap" icon="icon-[mdi--view-dashboard-variant]" aria-label="tree" />
              <Button value="sunburst" icon="icon-[mdi--circle-double]" aria-label="burst" />
            </ToggleButtonGroup>} />
      </Panel>;
  },
  args: {
...
}`,...b.parameters?.docs?.source}}},x=[`TreeMap`,`Sankey`]})))()}export{S as i,b as n,y as r,m as t};