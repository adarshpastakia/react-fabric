import{n as e}from"./rolldown-runtime.js";import{n as t,r as n,t as r}from"./glsl.js";import{n as i,t as a}from"./FloatBindUniform.js";import{n as o,t as s}from"./Matrix4BindUniform.js";import{n as c,t as l}from"./Float2BindUniform.js";import{n as u,t as d}from"./Texture2DBindUniform.js";import{r as f,t as p}from"./ReadDepth.glsl.js";function m(e,r){let a=e.fragment;a.include(p),a.uniforms.add(new l(`nearFar`,e=>e.camera.nearFar),new d(`depthMap`,e=>e.depth?.attachment),new o(`proj`,e=>e.camera.projectionMatrix),new i(`invResolutionHeight`,e=>1/e.camera.height),new o(`reprojectionMatrix`,e=>e.reprojection.matrix)).code.add(n`
  ...
  float rayMarchScreenReachFromWorldReach(vec3 startPosition, vec3 rayDirection, float rayMarchWorldReach) {
    ...
    return ${r.useProjectedRayLength?`length(projectedCoordOffset)`:`abs(projectedCoordOffset.y)`};
  }
  ...
  vec3 screenSpaceIntersectionWithLimits(
    ...
    float rayMarchDistance = ${r.useProjectedRayLength?`length(vanishingPointScreenOffset.xy)`:`abs(vanishingPointScreenOffset.y)`};
    ...
    for(int stepIndex = 0; stepIndex < rayMarchMaxStepsInt - 1; ++stepIndex) {
      ...
      ${t(!r.clampRayToScreen,`if (projectedPosition.x <= 0.0  || projectedPosition.x >= 1.0) {
        return vec3(projectedPosition, 0.0);
      }`)}
      ...
      ${t(r.clampRayToScreen,`projectedPosition = clamp(projectedPosition, vec2(0.0), vec2(0.999));`)}
    }
    return vec3(projectedPosition, 0.0);
  }
  ...
  vec3 screenSpaceIntersection(vec3 rayDirection, vec3 startPosition, vec3 viewDirection, vec3 normal, float rayStepOffset) {
    return screenSpaceIntersectionWithLimits(
      ...
      normal,
      rayStepOffset,
      ${n.float(r.rayMarchMaxReach)},
      ${n.float(r.rayMarchMaxSteps)}
    );
  }
  `)}function h(){return(h=e((()=>{f(),c(),a(),r(),s(),u()})))()}export{h as n,m as t};