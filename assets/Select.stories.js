import{j as n,aK as i}from"./iframe-BmpICDQJ.js";import{I as d}from"./Tooltip.js";import"./index.js";import{j as m}from"./DualList.js";import{m as s}from"./isEqual.js";const{fn:a}=__STORYBOOK_MODULE_TEST__,_={component:m,title:"@form/Select",parameters:{layout:"centered",jest:["form/tests/Select.test.tsx"]},decorators:[r=>n.jsx("div",{className:"max-w-lg w-screen",children:n.jsx(r,{})})]},t={render:r=>n.jsx(m,{...r,options:i.list,labelProperty:"name.common",valueProperty:"cca2",infoProperty:"name.official",renderer:e=>n.jsxs("div",{className:"flex gap-2 items-center",children:[n.jsx(d,{icon:`icon-[circle-flags--${e.iconCode}]`}),n.jsx("span",{className:"flex-1",children:e.name.common}),n.jsx("span",{className:"rounded-full text-xs bg-tint-500/10 px-1 py-px",children:e.phone})]})}),args:{label:"Select",placeholder:"Select...",groupProperty:"alpha",allowClear:!0,onEnterPressed:a(),onChange:a()}},l={render:r=>n.jsx(m,{...r,multiple:!0,options:i.list,labelProperty:"name.common",valueProperty:"cca2",renderer:e=>n.jsxs("div",{className:"flex gap-2 items-center",children:[n.jsx(d,{icon:`iconify-color circle-flags--${e.iconCode}`}),n.jsx("span",{className:"flex-1",children:e.name.common}),n.jsx("span",{className:"rounded-full text-xs bg-tint-500/10 px-1 py-px",children:e.phone})]})}),args:{label:"Select",placeholder:"Select...",groupProperty:"alpha",allowClear:!0,onEnterPressed:a(),onChange:a()}},c={render:r=>n.jsx(m,{...r,options:i.list,labelProperty:"name.common",valueProperty:"cca2",renderer:e=>n.jsxs("div",{className:"flex gap-2 items-center",children:[n.jsx(d,{icon:`iconify-color circle-flags--${e.iconCode}`}),n.jsx("span",{className:"flex-1",children:e.name.common}),n.jsx("span",{className:"rounded-full text-xs bg-tint-500/10 px-1 py-px",children:e.phone})]}),matcher:(e,o)=>s(e.name.common,o)||s(e.phone,o)}),args:{label:"Combo",placeholder:"Combo...",groupProperty:"alpha",allowClear:!0,searchable:!0,onEnterPressed:a(),onChange:a()}},p={render:r=>n.jsx(m,{...r,labelProperty:"name.common",valueProperty:"cca2",renderer:e=>n.jsxs("div",{className:"flex gap-2 items-center",children:[n.jsx(d,{icon:`iconify-color circle-flags--${e.iconCode}`}),n.jsxs("span",{className:"flex-1",children:[n.jsx("div",{children:e.name.common}),n.jsx("div",{className:" group-data-select-display:hidden text-xs text-muted",children:e.name.official})]}),n.jsx("span",{className:"rounded-full text-xs bg-tint-500/10 px-1 py-px",children:e.phone})]}),matcher:(e,o)=>s(e.name.common,o)||s(e.phone,o),onQuery:e=>new Promise(o=>{setTimeout(()=>{o(i.list.filter(u=>s(u.name.common,e)||s(u.name.official,e)))},1e3)})}),args:{label:"Combo",placeholder:"Search for country...",groupProperty:"alpha",allowClear:!0,searchable:!0,onEnterPressed:a(),onChange:a()}};var x,f,g;t.parameters={...t.parameters,docs:{...(x=t.parameters)==null?void 0:x.docs,source:{originalSource:`{
  render: args => {
...
}`,...(g=(f=t.parameters)==null?void 0:f.docs)==null?void 0:g.source}}};var h,y,b;l.parameters={...l.parameters,docs:{...(h=l.parameters)==null?void 0:h.docs,source:{originalSource:`{
